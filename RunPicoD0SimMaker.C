...
void RunPicoD0SimMaker(string d0list="testD0.list", string pico="testPico.list",
 string outFileName="Test_AnaMaker.root"/*, string badRunListFileName = "picoList_bad_MB.list"*/,int pYear = 2014, bool Testing = true, bool Sim = true)
{
   ...
   string mcfilename = "./TestLists/test2014.list";
   
   StPicoD0AnaMaker*  picoD0AnaMaker = new StPicoD0AnaMaker("picoD0AnaMaker", d0list.c_str(), outFileName.c_str(), picoDstMaker,grefmultCorrUtil,pYear,Sim, mcfilename.c_str());
